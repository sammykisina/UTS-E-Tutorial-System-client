...
import { Dropdown, TutorialManagement } from '@/components';
    ...
    >
      ...
      <div className='flex-1'>
        ...
        <div className='absolute bottom-2 left-2  bg-white w-[5rem] h-[5rem] flex justify-center items-center rounded-full'>
          {parseInt(tutorial?.attributes?.numberOfPointsForEachQuestion) *
